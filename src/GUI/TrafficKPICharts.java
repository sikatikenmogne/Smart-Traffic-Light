...
public class TrafficKPICharts {
     ...
     */
    public static LineChart<String, Number> createAverageSpeedChart() {
        CategoryAxis xAxis = new CategoryAxis();
        NumberAxis yAxis = new NumberAxis();
        LineChart<String, Number> lineChart = new LineChart<>(xAxis, yAxis);
        xAxis.setLabel("Time");
        yAxis.setLabel("Average Speed (km/h)");
        lineChart.getData().add(SampleData.getAverageSpeedData());
        return lineChart;
    }
     ...
     */
    public static AreaChart<String, Number> createTrafficFlowRateChart() {
        CategoryAxis xAxis = new CategoryAxis();
        NumberAxis yAxis = new NumberAxis();
        AreaChart<String, Number> areaChart = new AreaChart<>(xAxis, yAxis);
        xAxis.setLabel("Time");
        yAxis.setLabel("Traffic Flow Rate (vehicles/hour)");
        areaChart.getData().add(SampleData.getTrafficFlowRateData());
        return areaChart;
    }
     ...
     */
    public static LineChart<String, Number> createTravelTimeChart() {
        CategoryAxis xAxis = new CategoryAxis();
        NumberAxis yAxis = new NumberAxis();
        LineChart<String, Number> lineChart = new LineChart<>(xAxis, yAxis);
        xAxis.setLabel("Route");
        yAxis.setLabel("Travel Time (minutes)");
        lineChart.getData().add(SampleData.getTravelTimeData());
        return lineChart;
    }
     ...
     */
    public static BarChart<String, Number> createQueueLengthChart() {
        CategoryAxis xAxis = new CategoryAxis();
        NumberAxis yAxis = new NumberAxis();
        BarChart<String, Number> barChart = new BarChart<>(xAxis, yAxis);
        xAxis.setLabel("Traffic Light");
        yAxis.setLabel("Queue Length (vehicles)");
        barChart.getData().add(SampleData.getQueueLengthData());
        return barChart;
    }
     ...
     */
    public static ScatterChart<Number, Number> createIntersectionDelayChart() {
        NumberAxis xAxis = new NumberAxis();
        NumberAxis yAxis = new NumberAxis();
        ScatterChart<Number, Number> scatterChart = new ScatterChart<>(xAxis, yAxis);
        xAxis.setLabel("Time");
        yAxis.setLabel("Intersection Delay (seconds)");
        scatterChart.getData().add(SampleData.getIntersectionDelayData());
        return scatterChart;
    }
    ...
    public static PieChart createThroughputChart() {
        ...
        pieChart.getData().addAll(SampleData.getThroughputData());
        return pieChart;
    }
}